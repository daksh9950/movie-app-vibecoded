            ...
            <div className='w-full md:w-[80%] h-full overflow-auto overflow-x-hidden'>
                ...
                <div className='w-full px-[5%] py-6 pb-10'>
                    {history && history.length > 0 ? (
                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                            {history.slice().reverse().map((item, i) => (
                                <Link
                                    ...
                                    className='flex items-center gap-4 p-3 md:p-4 bg-[#2A2931] hover:bg-[#32313a] rounded-xl duration-200 border border-zinc-800 hover:border-[#6556CD]/50 group shadow-lg'
                                >
                                    ...
                                    <div className='flex-1 min-w-0'>
                                        <h2 className='text-zinc-100 font-bold text-base md:text-xl truncate group-hover:text-[#6556CD] duration-200'>{item.title}</h2>
                                        ...
                                        <div className='flex flex-wrap items-center gap-2 mt-2 md:mt-3'>
                                            ...
                                            {item.watchedAt && (
                                                <span className='text-[10px] md:text-xs text-zinc-500 font-medium flex items-center gap-1'>
                                                    <i className="ri-time-line"></i> {getTimeAgo(item.watchedAt)}
                                                </span>
                                            )}
                                        </div>
                                        
                                        <div className='hidden md:block mt-4 text-[#6556CD] text-sm font-semibold opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1'>
                        ...
                        <div className='flex flex-col items-center justify-center min-h-[50vh] text-zinc-400 text-center px-5'>
                            <div className='w-24 h-24 md:w-32 md:h-32 bg-[#2A2931] rounded-full flex items-center justify-center mb-6 shadow-inner'>
                                <i className="ri-history-fill text-5xl md:text-6xl text-[#6556CD] opacity-40"></i>
                            </div>
                            <h1 className='text-xl md:text-2xl font-bold tracking-wide text-zinc-200'>No watch history yet</h1>

            ...
            <div className='flex flex-col md:flex-row gap-10 mt-5' >
              ...
              <div className='flex-1 text-white' >
                  ...
                  <div className='mt-6 mb-6 flex flex-wrap items-center gap-5 md:gap-8' >
                     ...
                     <h1 className='text-zinc-300 font-medium' >{info.detail.release_date}</h1>
                     <h1 className='text-zinc-300 font-medium' >{info.detail.genres.map((g)=>g.name).join(", ")}</h1>
                     <h1 className='text-zinc-300 font-medium' >{info.detail.runtime} min</h1>
                  </div>
                  ...
                  <div className='mb-8'>
                    <h1 className='text-xl md:text-2xl font-bold mb-2'>Movies Translated</h1>
